  ...
  <div class="main">
    <div class="head">
      <div class="head1">
        ...
        <audio src="" autoplay="autoplay" controls="controls" id="ao" loop="loop"></audio>
        <div class="ss">
    ...
    <table cellspacing="0" cellpadding="0" border="1" id="tab">
      <tr>
        <td>歌曲</td>
        <td>歌手</td>
      </tr>
...
<script>
  $(function(){
    var  ph2='http://www.young1024.com:666/top/list?idx=2';
    $.ajax({
      type:"get",
      url: ph2,
      dataType: "json",
...
<style scoped>
  *{
  ...
  .main{
    width: 100%;
    height: 100%;
    background: url("../../assets/images/b5.jpg") ;
    background-size: 100%;
  }
  .head{
    width: 100%;
